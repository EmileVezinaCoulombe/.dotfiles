...
local mappings = {
    ...
    d = {
        ...
        B = { ":lua require'dap'.toggle_breakpoint(vim.fn.input('Breakpoint condition: '))<cr>", "Conditional breakpoint" },
        l = { ":lua require'dap'.toggle_breakpoint(nil, nil, vim.fn.input('Log point message: '))<cr>", "Log point" },
